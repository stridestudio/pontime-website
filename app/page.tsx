      ...
      <nav data-state={menuState && 'active'} className="group fixed z-20 w-full pt-2">
        <div
          className={cn(
            ...
            scrolled && 'bg-[#1a3a2e]/95 backdrop-blur-2xl border border-accent/20'
          )}
        >
          <motion.div
            className={cn(
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mx-auto grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.1 }}
              >
                <Card className="group overflow-hidden shadow-xl bg-card border-border hover:border-accent/50 transition-all h-full">
                  <CardHeader>
              ...
              >
                <Card className="group overflow-hidden shadow-xl bg-card border-border hover:border-accent/50 transition-all">
                  <CardHeader>
